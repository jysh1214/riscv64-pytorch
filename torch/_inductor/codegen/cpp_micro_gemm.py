...
inline void {{kernel_name}}_amx_kernel_{{num_rows}}_{{num_columns}}(
    ...
    {{input_t}} bf16_weights_buf[512 * {{num_columns}}];
    memset(bf16_weights_buf, 0, 1024 * {{num_columns}});
    {%- endif %}
    ...
    for cls, configs in micro_gemm_configs.items():
        for config in configs:
            ...
            if (
                ...
                # For int8 WoQ GEMM, with AVX512/AV2 micro-kernel, output dtype
